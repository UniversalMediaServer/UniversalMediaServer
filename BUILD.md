...
1) Build UMS
2) Set a variable storing the directory path of the build distribution file, e.g.
...
3) Replace desired path inside the  .pkgproj file
...
4) Build .pkg installer. This will output to `/target/Universal Media Server.pkg`

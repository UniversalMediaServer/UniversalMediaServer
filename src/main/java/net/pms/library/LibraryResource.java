...
public abstract class LibraryResource implements Cloneable, Runnable {
	...
	private LibraryContainer parent;
	 ...
	 */
	public void setParent(LibraryContainer parent) {
		this.parent = parent;
	}
	...
	/**
	 * Any {@link LibraryResource} needs to represent the container or item with
	 * a String.
	 *
	...
	public void setPrimaryResource(LibraryResource first) {
		this.first = first;
	}
	...
	public void setSecondaryResource(LibraryResource second) {
		this.second = second;
	}
	...
	public String getDisplayName(boolean withSuffix) {
		...
		if (this instanceof LibraryItem item) {

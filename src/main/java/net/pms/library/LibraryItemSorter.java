 ...
 */
public class LibraryItemSorter implements Comparator<LibraryItem> {
	...
	@Override
	public int compare(LibraryItem resource1, LibraryItem resource2) {
	...
	private static String getMediaAudioLanguage(LibraryItem resource) {
		return resource.getMediaAudio() == null ? null : resource.getMediaAudio().getLang();
	}

	private static String getMediaSubtitleLanguage(LibraryItem resource) {

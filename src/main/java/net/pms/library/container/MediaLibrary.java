...
public class MediaLibrary extends MediaLibraryAbstract {
	...
	private LibraryContainer vfAudio = null;
	...
	public final void reset() {
		enabled = CONFIGURATION.getUseCache() && renderer.getUmsConfiguration().getUseCache();
		if (!enabled) {
			return;
		}
		addVideoFolder();
	...
	private void addVideoFolder() {
		// Videos folder
		LibraryContainer vfVideo = new LibraryContainer(renderer, Messages.getString("Video"), null);
	...
	private void addAudioFolder() {
		vfAudio = new LibraryContainer(renderer, Messages.getString("Audio"), null);
	...
	private void addImageFolder() {
		LibraryContainer vfImage = new LibraryContainer(renderer, Messages.getString("Photo"), null);
	...
	public LibraryContainer getAudioFolder() {
		return vfAudio;
	}

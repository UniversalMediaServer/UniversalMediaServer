...
public class MediaLibrary extends MediaLibraryAbstract {
	...
	private void addVideoFolder() {
		// Videos folder
		VirtualFolder vfVideo = new VirtualFolder(renderer, Messages.getString("Video"), null);
	...
	private void addAudioFolder() {
		vfAudio = new VirtualFolder(renderer, Messages.getString("Audio"), null);
	...
	private void addImageFolder() {
		VirtualFolder vfImage = new VirtualFolder(renderer, Messages.getString("Photo"), null);

...
public class WinUtils extends BasicSystemUtils {
	...
	public void disableGoToSleep() {
		LOGGER.trace("Calling SetThreadExecutionState ES_AWAYMODE_REQUIRED");
		Kernel32.INSTANCE.SetThreadExecutionState(Kernel32.ES_AWAYMODE_REQUIRED | Kernel32.ES_CONTINUOUS);
	}

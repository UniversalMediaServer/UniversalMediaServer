	...
	private void init() {
		...
		tvShowsFolder = new MediaLibraryFolder(
			...
			new String[]{
				...
				"SELECT DISTINCT * FROM FILES LEFT JOIN FILES_STATUS ON FILES.ID = FILES_STATUS.FILEID WHERE TYPE = 4 AND ISTVEPISODE AND MOVIEORSHOWNAME = '${1}' AND TVSEASON = '${0}' ORDER BY ISFULLYPLAYED, TVEPISODENUMBER"
			},

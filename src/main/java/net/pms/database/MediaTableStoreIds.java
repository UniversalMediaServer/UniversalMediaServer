		...
		for (int version = currentVersion; version < TABLE_VERSION; version++) {
			...
			switch (version) {
				case 1 -> {
					...
					executeUpdate(connection, CREATE_INDEX + IF_NOT_EXISTS + TABLE_NAME + CONSTRAINT_SEPARATOR + COL_NAME + COL_OBJECT_TYPE + COL_PARENT_ID + IDX_MARKER + ON + TABLE_NAME + "(" + COL_NAME + ", " + COL_OBJECT_TYPE + ", " + COL_PARENT_ID + ")");

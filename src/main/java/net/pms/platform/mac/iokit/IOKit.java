...
import net.pms.platform.mac.corefoundation.CoreFoundation.CFAllocatorRef;
import net.pms.platform.mac.corefoundation.CoreFoundation.CFDictionaryRef;
import net.pms.platform.mac.corefoundation.CoreFoundation.CFDictionaryRefByReference;
...
import net.pms.platform.mac.types.IOConnectT;
import net.pms.platform.mac.types.IOConnectTRef;
...
import net.pms.platform.mac.types.IORegistryEntryTRef;
import net.pms.platform.mac.types.IOServiceT;
import net.pms.platform.mac.types.IOServiceTRef;
import net.pms.platform.mac.types.IOStringT;

 ...
 * {@link com.drew.metadata.gif.GifControlDirectory} which doesn't exist in the
 * current release. All extra functionality here has been merged into the
 * project, so when the next version is available, this class can be removed.
 *
...
public class GifControlDirectory extends Directory
{
    ...
    {
        this.setDescriptor(new TagDescriptor<GifControlDirectory>(this));
    }

 ...
 */
public class SourceImageInputStream implements ImageInputStream, Closeable {
     ...
     */
    public SourceImageInputStream() {
    }

    public SourceImageInputStream(FileChannel channel)
        throws IOException {

...
public class OpenSubtitleFolder extends StoreContainer {
	...
	public OpenSubtitleFolder(Renderer renderer, StoreItem resource) {
	...
	public void discoverChildren() {
		try {
			...
			for (SubtitleItem subtitleItem : subtitleItems) {
				...
				StoreItem liveResource = originalResource.clone();

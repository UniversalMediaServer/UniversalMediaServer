...
public class RendererConfiguration extends UPNPHelper.Renderer {
	...
	public static void delete(final RendererConfiguration r, int delay) {
		...
		javax.swing.Timer t = new javax.swing.Timer(delay, (ActionEvent event1) -> {
	 ...
	 * Automatic reloading
	 */
	public static final FileWatcher.Listener reloader = (String filename, String event1, FileWatcher.Watch watch, boolean isDir) -> {

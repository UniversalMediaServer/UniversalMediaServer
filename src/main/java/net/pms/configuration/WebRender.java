...
public class WebRender extends DeviceConfiguration implements RendererConfiguration.OutputOverride {
	...
	public boolean load(File f) {
		...
		configuration.addProperty(SUPPORTED, "f:wav n:2 a:lpcm m:audio/wav");
		configuration.addProperty(SUPPORTED, "f:webm v:vp8|vp9 m:video/webm");
		configuration.addProperty(SUPPORTED, "f:webm a:vorbis|opus m:audio/webm");
		...
		configuration.addProperty(SUPPORTED, "f:webp m:image/webp");

...
public class PmsConfiguration extends RendererConfiguration {
	...
	public Locale getLanguageLocale() {
		...
		if (languageCode != null && !languageCode.isEmpty()) {
			locale = Languages.toLocale(Languages.localeFromTag(languageCode));
			if (locale == null) {
		...
		if (locale == null) {
			...
			if (locale == null) {
				LOGGER.error("Unsupported language tag \"{}\", defaulting to US English.", Languages.toLanguageCode(Locale.getDefault()));
			}
		}

		if (locale == null) {
			locale = Languages.localeFromTag("en-US"); // Default
		}
		return locale;
	}
	...
	public String getLanguageTag() {
		return Languages.toLanguageTag(getLanguageLocale());
	}
	...
	public void setLanguage(Locale locale) {
		if (locale != null) {
			if (Languages.isValid(locale)) {
				...
				LOGGER.error("setLanguage() aborted because of unsupported language tag \"{}\"", Languages.toLanguageTag(locale));
			}
		} else {
	...
	public void setLanguage(String value) {
		if (value != null && !value.isEmpty()) {
			setLanguage(Languages.localeFromTag(value));
		} else {
	...
	public boolean isAdmin() {
		...
		return true;
					...
					LOGGER.debug("Interrupted while checking {} permissions: {}", Platform.isMac() ? "OS X" : "Linux" ,e.getMessage());
				}
			}
			admin = Boolean.valueOf(false);
			return false;

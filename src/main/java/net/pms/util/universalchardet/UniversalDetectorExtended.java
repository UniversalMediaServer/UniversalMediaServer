...
public class UniversalDetectorExtended
{
    ////////////////////////////////////////////////////////////////
    // constants
    ////////////////////////////////////////////////////////////////
     ...
     */
    public UniversalDetectorExtended(CharsetListener listener)
    {
            ...
            if ((c & 0x80) != 0 && c != 0xA0) {
                if (this.inputState != InputState.HIGHBYTE) {
                    ...
                    if (this.probers[1] == null) {
                        this.probers[1] = new SBCSGroupProberExtended();
                    }
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        UniversalDetectorExtended detector = new UniversalDetectorExtended(
                new CharsetListener() {

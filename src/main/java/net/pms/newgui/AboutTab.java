...
public class AboutTab {
	...
	public JComponent build() {
		...
		JLabel lPms3Link = builder._addLabel(pms3Link.getLabel(), cc.xy(2, 1, "center, fill"));
		...
		JLabel lCommitLink = builder._addLabel(commitLink.getLabel(), cc.xy(2, 3, "center, fill"));
		...
		builder._addLabel(Messages.getString("LinksTab.5"), cc.xy(2, 7, "center, fill"));

		final LinkMouseListener ps3msLink = new LinkMouseListener("PS3 Media Server", "http://www.ps3mediaserver.org/");
		JLabel lPs3msLink = builder._addLabel(ps3msLink.getLabel(), cc.xy(2, 9, "center, fill"));
		...
		JLabel lFfmpegLink = builder._addLabel(ffmpegLink.getLabel(), cc.xy(2, 11, "center, fill"));
		...
		JLabel lMplayerLink = builder._addLabel(mplayerLink.getLabel(), cc.xy(2, 13, "center, fill"));
		...
		JLabel lSpirtonLink = builder._addLabel(spirtonLink.getLabel(), cc.xy(2, 15, "center, fill"));
		...
		JLabel lMediaInfoLink = builder._addLabel(mediaInfoLink.getLabel(), cc.xy(2, 17, "center, fill"));
		...
		JLabel lAvisynthMTLink = builder._addLabel(avisynthMTLink.getLabel(), cc.xy(2, 19, "center, fill"));
		...
		JLabel lDryIconsLink = builder._addLabel(dryIconsLink.getLabel(), cc.xy(2, 21, "center, fill"));
		...
		JLabel lSVPLink = builder._addLabel(svpLink.getLabel(), cc.xy(2, 23, "center, fill"));

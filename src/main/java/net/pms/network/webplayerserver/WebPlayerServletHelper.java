...
public class WebPlayerServletHelper {
	private static final Logger LOGGER = LoggerFactory.getLogger(WebPlayerServletHelper.class);
	private static final Gson GSON = new Gson();
	protected static final PmsConfiguration CONFIGURATION = PMS.getConfiguration();
	private static final String HTTPSERVER_REQUEST_BEGIN =  "============================= PLAYER HTTPSERVER REQUEST BEGIN ================================";
	private static final String HTTPSERVER_REQUEST_END =    "============================= PLAYER HTTPSERVER REQUEST END ==================================";
	private static final String HTTPSERVER_RESPONSE_BEGIN = "============================= PLAYER HTTPSERVER RESPONSE BEGIN ===============================";
	private static final String HTTPSERVER_RESPONSE_END =   "============================= PLAYER HTTPSERVER RESPONSE END =================================";
	private static final ClassLoader CLASS_LOADER = new URLClassLoader(new URL[] {getUrl("file:" + CONFIGURATION.getWebPath() + "/player/")});

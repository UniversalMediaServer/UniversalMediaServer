...
public class I18nApiServlet extends PlayerHttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
		try {
			...
			switch (path) {
				case "/" -> {
					JsonObject post = WebPlayerServletHelper.getJsonObjectFromBody(req);
					...
					WebPlayerServletHelper.respond(req, resp, i18n.toString(), 200, "application/json");
				}
				default -> {

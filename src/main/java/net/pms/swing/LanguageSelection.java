...
public class LanguageSelection {
	...
	public void show() {
		if (PMS.isHeadless()) {
			...
			dialog.setIconImage(SwingUtil.getAppIconImage());
			setStrings();
			dialog.pack();
	...
	private void setStrings() {
		...
		float avgCharWidth = SwingUtil.getComponentAverageCharacterWidth(descriptionText);
		...
		descriptionText.setPreferredSize(SwingUtil.getWordWrappedTextDimension(descriptionText, textWidth));
		...
		warningText.setPreferredSize(SwingUtil.getWordWrappedTextDimension(warningText, textWidth));
		...
		infoText.setPreferredSize(SwingUtil.getWordWrappedTextDimension(infoText, textWidth, StringUtil.stripHTML(infoText.getText())));

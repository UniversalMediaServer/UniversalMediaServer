...
public class DLNAMediaInfoTest {
	...
	public static void setUpBeforeClass() {
		...
		for (int i = 0; i < test_files.length; ++i) {
			...
			dlnaResourceIds[i] = dlna.getIntId();
		}
	}

	@Test
	public void testContainerProperties() throws Exception {
		DLNAResource mp4Video = PMS.getGlobalRepo().get(dlnaResourceIds[0]);
		...
		DLNAResource mkvVideo = PMS.getGlobalRepo().get(dlnaResourceIds[1]);
		...
		DLNAResource mkvHevcVideo = PMS.getGlobalRepo().get(dlnaResourceIds[2]);
		...
		DLNAResource oggVideo = PMS.getGlobalRepo().get(dlnaResourceIds[3]);
		...
		DLNAResource m4vVideo = PMS.getGlobalRepo().get(dlnaResourceIds[4]);
		...
		DLNAResource a3g2Video = PMS.getGlobalRepo().get(dlnaResourceIds[5]);
		...
		DLNAResource aviVideo = PMS.getGlobalRepo().get(dlnaResourceIds[6]);
		...
		DLNAResource movVideo = PMS.getGlobalRepo().get(dlnaResourceIds[7]);
		...
		DLNAResource wmvVideo = PMS.getGlobalRepo().get(dlnaResourceIds[8]);
		...
		DLNAResource webmVideo = PMS.getGlobalRepo().get(dlnaResourceIds[9]);
		...
		DLNAResource flvVideo = PMS.getGlobalRepo().get(dlnaResourceIds[10]);
		...
		DLNAResource aviH264Video = PMS.getGlobalRepo().get(dlnaResourceIds[11]);
		...
		DLNAResource wavAudio = PMS.getGlobalRepo().get(dlnaResourceIds[12]);
		...
		DLNAResource vorbisAudio = PMS.getGlobalRepo().get(dlnaResourceIds[13]);
		...
		DLNAResource mp3Audio = PMS.getGlobalRepo().get(dlnaResourceIds[14]);
		...
		DLNAResource av1Video = PMS.getGlobalRepo().get(dlnaResourceIds[15]);
		...
		DLNAResource av1Video2 = PMS.getGlobalRepo().get(dlnaResourceIds[16]);

...
public class PmsConfigurationTest {
	...
	public void testLoggingConfigurationDefaults() {
		...
		assertEquals("getLanguageLocaleBritishEnglish", configuration.getLanguageLocale(), Languages.localeFromTag("en-GB"));
		...
		assertEquals("getLanguageLocaleEnglish", configuration.getLanguageLocale(), Languages.localeFromTag("en-US"));
		...
		assertEquals("getLanguageLocaleChinese", configuration.getLanguageLocale(), Languages.localeFromTag("zh-Hant"));
		assertEquals("getLanguageTagChinese", configuration.getLanguageTag(), "zh-Hant");
		configuration.setLanguage(Locale.UK);
		assertEquals("setLanguageUK", configuration.getLanguageLocale(), Languages.localeFromTag("en-GB"));
		configuration.setLanguage(Locale.SIMPLIFIED_CHINESE);
		assertEquals("setLanguageSimplifiedChinese", configuration.getLanguageLocale(), Languages.localeFromTag("zh-Hans"));
		configuration.setLanguage(Locale.TRADITIONAL_CHINESE);
		assertEquals("setLanguageTraditionalChinese", configuration.getLanguageLocale(), Languages.localeFromTag("zh-Hant"));
		Locale locale = null;
		configuration.setLanguage(locale);
		assertEquals("setLanguageNull", configuration.getLanguageLocale(), Languages.localeFromTag("zh-Hant"));
		String code = null;
		configuration.setLanguage(code);
		assertEquals("setLanguageNull", configuration.getLanguageLocale(), Languages.localeFromTag("zh-Hant"));
		configuration.setLanguage("");
		assertEquals("setLanguageEmpty", configuration.getLanguageLocale(), Languages.localeFromTag("zh-Hant"));
		configuration.setLanguage("en");
		assertEquals("setLanguageEnglish", configuration.getLanguageLocale(), Languages.localeFromTag("en-US"));
	}
}

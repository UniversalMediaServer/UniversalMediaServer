...
export default function TranscodingSettings({
  ...
  const setTranscodingEngineStatus = (id: string, enabled: boolean) => {
    ...
    if (enabled && !included) {
      ...
      const updated = items.filter(function (value) {
        return value !== id
      },
      )
      form.setFieldValue('engines', updated)
              ...
              <Stack gap="xs">
                ...
                <Group>
                  ...
                  <ColorSwatch
                    ...
                    onClick={() => {
                      if (canModify) {
                        setSubColor(hexAToRgba(form.getInputProps('subtitles_color').value))
                        setSubColorModalOpened(true)
                      }
                    }}
                  />
                </Group>
        ...
        <Stack gap="xs">
          ...
          <Grid>
            <Grid.Col span={6}>
              ...
              >
                {i18n.get('AddBordersOverscanCompensation')}
              </Text>
            </Grid.Col>
            <Grid.Col span={3}>
              <TextInput

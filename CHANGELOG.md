...
- Bump `com.fasterxml.jackson.core:jackson-databind` from 2.19.2 to 2.20.0 ([#5725](https://github.com/UniversalMediaServer/UniversalMediaServer/pull/5725))
...
- Bump `typescript-eslint` from 8.38.0 to 8.40.0 ([#5712](https://github.com/UniversalMediaServer/UniversalMediaServer/pull/5712))

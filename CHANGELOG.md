...
- Bump `io.github.git-commit-id:git-commit-id-maven-plugin` from 9.0.2 to 10.0.0 ([#6103](https://github.com/UniversalMediaServer/UniversalMediaServer/pull/6103))
